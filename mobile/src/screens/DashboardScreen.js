  ...
  return (
    <View style={s.root}>
      ...
      <ScrollView style={s.scroll} contentContainerStyle={s.content}>
        ...
        {projects.length === 0
          ? <Text style={s.empty}>No projects yet. Create one from Projects tab.</Text>
        ...
        <View style={s.dueCard}>
          ...
          <Text style={[s.dueNum, { color: K.mid }]}>{summary?.due_24h ?? '—'} tasks</Text>
        </View>
      </ScrollView>
    </View>
  );
...
const s = StyleSheet.create({
  ...
  statNum:   { fontSize: 32, ...FONT.black },
  ...
  chevron:   { color: K.muted, fontSize: 20 },
  ...
  dueNum:    { fontSize: 20, fontWeight: '900' },
});
